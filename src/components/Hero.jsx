...
export default function Hero() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-white bg-black tracking-wider leading-loose font-climate-crisis">
      <h1 className="gif-text text-[100px] font-climate-crisis uppercase text-center w-full">
        Abrielle Perry
      </h1>
